...
Axon 的文档已重新组织，请查阅以下指南：

### 🏁 入门
*   **[简介](docs/01_introduction.md)**: 了解 Axon 的设计哲学。
...
### 🤖 提示工程
*   **[Prompt 指南](docs/04_prompting_guide.md)**: **(重要)** 如何编写 System Prompt 让 AI 生成 Axon 兼容的脚本。

### 💻 开发者
*   **[架构解析](docs/05_developer_guide/01_architecture.md)**: 幽灵引擎与核壳分离架构。
*   **[插件开发](docs/05_developer_guide/02_adding_new_acts.md)**: 如何扩展 Axon 的能力。
